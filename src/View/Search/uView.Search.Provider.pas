...
uses
	...
	Vcl.Mask, Vcl.ExtCtrls,frxClass, frxDBSet, frxExportBaseDialog, frxExportPDF, uView.Search.Template;

type
	TProviderSearchView = class(TTemplateSearchView)
...
var
	ProviderSearchView: TProviderSearchView;

implementation

{$R *.dfm}

procedure TProviderSearchView.btnImprimirClick(Sender: TObject);
begin
	NomeRelatorio := 'relFornecedor.fr3';
	inherited;
end;

procedure TProviderSearchView.btnPesquisarClick(Sender: TObject);
begin
	inherited;
...
procedure TProviderSearchView.btnTransferirClick(Sender: TObject);
begin
	inherited;

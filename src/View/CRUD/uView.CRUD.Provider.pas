...
uses
	...
	FireDAC.DApt, Data.DB, FireDAC.Comp.DataSet, FireDAC.Comp.Client, Vcl.DBCtrls, Vcl.StdCtrls, 
	Vcl.Buttons, Vcl.ExtCtrls, Vcl.Mask, uView.CRUD.Template;

type
	TProviderCRUDView = class(TTemplateCRUDView)
...
var
	ProviderCRUDView: TProviderCRUDView;
...
uses 
	uDM, uView.Search.Provider;

procedure TProviderCRUDView.btnNovoClick(Sender: TObject);
begin
	inherited;
...
procedure TProviderCRUDView.btnPesquisarClick(Sender: TObject);
var
	ObjFrmPesquisaFornecedor : TProviderSearchView;
begin
	inherited;
		ObjFrmPesquisaFornecedor := TProviderSearchView.Create(nil);
	try

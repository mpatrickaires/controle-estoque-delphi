...
uses
  ...
  Vcl.Mask, uDM, uView.GRID.Template;

type
  TSalesGRIDView = class(TTemplateGRIDView)
...
var
  SalesGRIDView: TSalesGRIDView;

implementation

{$R *.dfm}

procedure TSalesGRIDView.btnItemClick(Sender: TObject);
var
  Proximo : Integer;
begin
  inherited;
...
procedure TSalesGRIDView.btnNovoClick(Sender: TObject);
begin
  inherited;
...
procedure TSalesGRIDView.btnOkClick(Sender: TObject);
begin
  inherited;
  qryPadrao.Edit;
...
procedure TSalesGRIDView.edtIDProdutoExit(Sender: TObject);
begin
  inherited;
